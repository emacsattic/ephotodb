...
pkgdatadir = $(datadir)/ephotodb
pkglibdir = $(libdir)/ephotodb
pkgincludedir = $(includedir)/ephotodb
top_builddir = .
...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	ChangeLog INSTALL NEWS elisp-comp install-sh missing \
	texinfo.tex
...
SOURCES =
DIST_SOURCES =
INFO_DEPS = $(srcdir)/ephotodb.info
am__TEXINFO_TEX_DIR = $(srcdir)
DVIS = ephotodb.dvi
PDFS = ephotodb.pdf
PSS = ephotodb.ps
HTMLS = ephotodb.html
TEXINFOS = ephotodb.texi
TEXI2DVI = texi2dvi
...
ACLOCAL = ${SHELL} /home/markus/prog/ephotodb/trunk/missing --run aclocal-1.9
AMTAR = ${SHELL} /home/markus/prog/ephotodb/trunk/missing --run tar
AUTOCONF = ${SHELL} /home/markus/prog/ephotodb/trunk/missing --run autoconf
AUTOHEADER = ${SHELL} /home/markus/prog/ephotodb/trunk/missing --run autoheader
AUTOMAKE = ${SHELL} /home/markus/prog/ephotodb/trunk/missing --run automake-1.9
AWK = gawk
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"\" -DPACKAGE_TARNAME=\"\" -DPACKAGE_VERSION=\"\" -DPACKAGE_STRING=\"\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE=\"ephotodb\" -DVERSION=\"0.5\"
ECHO_C = 
ECHO_N = -n
ECHO_T = 
EMACS = emacs
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/markus/prog/ephotodb/trunk/missing --run makeinfo
PACKAGE = ephotodb
PACKAGE_BUGREPORT = 
PACKAGE_NAME = 
PACKAGE_STRING = 
...
install_sh = /home/markus/prog/ephotodb/trunk/install-sh
...
mydb2texi = /usr/local/bin/docbook2texi
myshell = /bin/sh
...
$(srcdir)/ephotodb.info: ephotodb.texi 
ephotodb.dvi: ephotodb.texi 
ephotodb.pdf: ephotodb.texi 
ephotodb.html: ephotodb.texi 
.dvi.ps:
	TEXINPUTS="$(am__TEXINFO_TEX_DIR)$(PATH_SEPARATOR)$$TEXINPUTS" \
	$(DVIPS) -o $@ $<
...
mostlyclean-aminfo:
	-rm -rf ephotodb.aux ephotodb.cp ephotodb.cps ephotodb.fn ephotodb.fns \
	  ephotodb.ky ephotodb.kys ephotodb.log ephotodb.pg \
	  ephotodb.pgs ephotodb.tmp ephotodb.toc ephotodb.tp \
	  ephotodb.tps ephotodb.vr ephotodb.vrs ephotodb.dvi \
	  ephotodb.pdf ephotodb.ps ephotodb.html
...
distdir: $(DISTFILES)
	$(am__remove_distdir)
	mkdir $(distdir)
	$(mkdir_p) $(distdir)/ephotodb-manual
	@srcdirstrip=`echo "$(srcdir)" | sed 's|.|.|g'`; \
...
install-data-am: install-docDATA install-info-am install-lispLISP
...
uninstall-am: uninstall-docDATA uninstall-info-am uninstall-lispLISP

.PHONY: all all-am am--refresh check check-am clean clean-generic \
	clean-lisp dist dist-all dist-bzip2 dist-gzip dist-info \
	...
	uninstall-docDATA uninstall-info-am uninstall-lispLISP
...
ephotodb.texi: ephotodb-manual.xml
	/usr/local/bin/docbook2texi --to-stdout ephotodb-manual.xml > $@
